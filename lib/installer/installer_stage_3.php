...
if (file_exists("dbconnect.php")){
	...
	rawoutput("<input name='DB_DATACACHEPATH' value=\"".(array_key_exists('DB_DATACACHEPATH',$session['dbinfo'])?htmlentities($session['dbinfo']['DB_DATACACHEPATH'], ENT_COMPAT, getsetting("charset", "ISO-8859-1")):"")."\">");
